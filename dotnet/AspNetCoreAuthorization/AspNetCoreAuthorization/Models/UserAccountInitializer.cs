...
{
    public class UserAccountInitializer : IUserAccountInitializer
	{
		public async Task CreateUserAccounts(IServiceProvider serviceProvider, IConfiguration configuration)
		{
