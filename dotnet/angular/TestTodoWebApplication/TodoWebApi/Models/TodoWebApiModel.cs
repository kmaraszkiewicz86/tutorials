...
namespace TodoWebApi.Models
{
	...
	public class TodoWebApiModel
	{
		...
		public TodoWebApiModel(int id, string title, bool completed, DateTime createTime)
		{
			Id = id;
			Title = title;
			Completed = completed;
		...
		/// <param name="completed">if set to <c>true</c> [completed].</param>
		/// <param name="createTime">The create time.</param>
		public TodoWebApiModel(string title, bool completed, DateTime createTime)
		{
			Title = title;
			Completed = completed;
			CreateTime = createTime;
		...
		{
			return Equals(obj as TodoWebApiModel);
		}
		...
		/// <returns></returns>
		public bool Equals(TodoWebApiModel todoModel)
		{
