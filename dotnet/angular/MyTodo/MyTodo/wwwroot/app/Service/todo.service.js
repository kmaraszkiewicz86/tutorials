...
var TodoService = /** @class */ (function () {
    ...
    TodoService.prototype.getPendingTodos = function () {
        this.http.get('/api/todos/pending-only')
            .subscribe(function (err) { return console.log(err); }, function () { return console.log('getTodos completed'); });
    };
    ...
    TodoService.prototype.deleteTodo = function (todo) {
        this.http.delete('/api/todos/' + todo.id)
            .subscribe(function (err) { return console.log(err); }, function () { return console.log('delete completed'); });
    };
